...
object ModelLoader {
    ...
    fun loadModel(objpath: String, pitch: Float, yaw: Float, roll: Float): Renderable? {
        ...
        val stride = 8 * 4
        val atr1 = VertexAttribute(0, 3, GL11.GL_FLOAT, false, stride, 0)
        val atr2 = VertexAttribute(1, 2, GL11.GL_FLOAT, false, stride, 3 * 4)
        val atr3 = VertexAttribute(2, 3, GL11.GL_FLOAT, false, stride, 5 * 4)
